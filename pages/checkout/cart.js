                              ...
                              <div className="d-flex flex-row align-items-center">
                                <div>
                                  <img
                                    ...
                                    className="img-fluid rounded- imgCart" alt="Shopping item" />
                                </div>
                                <div className="ms-3">
                                  <h5>Iphone 11 pro</h5>
                              ...
                              <div className="d-flex flex-row align-items-center">
                                <div>
                                  <img
                                    ...
                                    className="img-fluid rounded-3 imgCart " alt="Shopping item"/>
                                </div>
                                <div className="ms-3">
                          ...
                          <div className="card-body">
                            <div className="d-flex justify-content-between align-items-center mb-4">
                              ...
                              <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/avatar-6.webp"
                                className="img-fluid rounded-3 imgCart" alt="Avatar" />
                            </div>
